 ...
 * 
 */
public class NewsTradeAdapter extends BaseAdapter {
	private ArrayList<News> mNewsList;
	private int mPageNumber = 1;
	private int mPageSize = Constant.PAGE_SIZE;
	private Activity mContext;

	public NewsTradeAdapter(Activity context, ArrayList<News> newsList) {
		mNewsList = newsList;
		mContext = context;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mContext.getLayoutInflater().inflate(
					R.layout.news_listitem_trade, null);
			viewHolder.mTitleTv = (TextView) convertView
					.findViewById(R.id.tv_news_trade_listitem_title);
			viewHolder.mBriefTv = (TextView) convertView
					.findViewById(R.id.tv_news_trade_listitem_brief);
			viewHolder.mDateTv = (TextView) convertView
					.findViewById(R.id.tv_news_trade_listitem_date);
			viewHolder.mImageSiv = (SmartImageView) convertView
					.findViewById(R.id.siv_news_trade_listitem_image);
