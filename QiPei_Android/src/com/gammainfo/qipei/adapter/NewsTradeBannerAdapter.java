...
public class NewsTradeBannerAdapter extends PagerAdapter implements
	...
	public NewsTradeBannerAdapter(Activity context, ArrayList<News> bannerList) {
		mContext = context;
	...
	public Object instantiateItem(ViewGroup container, int position) {
		View view = mLayoutInflater.inflate(
				R.layout.news_listitem_trade_banner, null);
		TextView BannerTitle = (TextView) view
				.findViewById(R.id.tv_news_trade_banner_title);
		SmartImageView BannerImage = (SmartImageView) view
				.findViewById(R.id.siv_news_trade_banner_image);
